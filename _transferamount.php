...
<?php
    ...
    echo "<form method='POST' action='_transtatus.php' class='form'>
    <b>SELECT RECEIVER : </b> 
    <select class='custom-select select_c size' name='receiver' required>";
  ...
  echo '</select><br><br>';
    ...
    echo "<label for='money'> <b>INSERT AMOUNT : </b></label><br>
    <input type='number' name='money' id='money' min='0' required><br><br><br>
    <input type='hidden' name='uid' value='$sender'>     
    <div class='style_but'>
    <input type='submit'  class='btn btn-info btn-lg btn-block btn1' value = 'Send'>";
