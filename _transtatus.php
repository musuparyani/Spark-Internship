  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sender = $_POST['uid'];
            ...
            if($sending_money<=$sender_bal){
                ...
                <h1 class="alert-heading">Transaction Successful!</h1>
                <p>Money has been successfully transfered money</p>
                <hr>
                <p class="mb-0">Your all transactions are here.
                <a href="transactions.php">
                Transactions portal</a></p><br>
              </div>';
                echo "<div class='style_trans'>
                <button type='button' class='btn btn-info btt' ><a href='trans.php' style='color:white; font-weight:bold'>Make another transaction</a></button>
               </div>";
               echo "<div class='style_home'>
               <button type='button' class='btn btn-info btt'><a href='_start.php' style='color:white; padding:0px 73px; font-weight:bold'>Home</a></button>
               </div>";
